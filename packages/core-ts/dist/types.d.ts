...
export type AuditEventType = 'adapter_created' | 'adapter_activated' | 'adapter_quarantined' | 'adapter_destroyed' | 'kill_switch_activated' | 'signature_verified' | 'policy_evaluated';
